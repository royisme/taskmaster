  ...
  return (
    <button
      ...
      className={`
        ...
        text-gray-700  border border-gray-300 rounded-xl text-lg
        hover:bg-gray-50 focus:outline-none focus:ring-2 
        focus:ring-offset-2 focus:ring-teal-500 transition-colors
        disabled:opacity-50 disabled:cursor-not-allowed bg-teal-400
      `}
    >
      <svg className="w-5 h-5" viewBox="-3 0 262 262"  preserveAspectRatio="xMidYMid">
